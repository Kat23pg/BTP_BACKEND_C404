CLASS zcl_insert_data_2803 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_insert_data_2803 IMPLEMENTATION.
...
*último_cambio_en: abp_lastchange_tstmpl;

 data:     lt_acc_categ type table of  ZTB_ACC_CATEG_03,
          lt_catego type table of  ZTB_CATEGO_2803,
          lt_clientes type table of  ZTB_CLIENTES_03,
          lt_clnts_lib type table of  ZTB_CLNTS_LIB_03,
          lt_libros type table of  ZTB_LIBROS_2803.
...
*"Eliminar entradas posibles; insertar nuevas entradas"
    DELETE FROM ZTB_ACC_CATEG_03.
    INSERT ZTB_ACC_CATEG_03 FROM TABLE @lt_acc_categ.
...
******** TABLA2 ********
    ...
    "Eliminar entradas posibles; insertar nuevas entradas"
    DELETE FROM ZTB_CATEGO_2803.
    INSERT ZTB_CATEGO_2803 FROM TABLE  @lt_catego.
...
******** TABLA3 ********
    ...
    ( id_cliente = '234234231T' tipo_acceso = '5' nombre = 'Penélope' apellidos = 'King' email = 'CAROLINE.KING@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ...
    ( id_cliente = '540867547H' tipo_acceso = '5' nombre = 'Adrian' apellidos = 'Joven' email = 'PENELOPE.YOUNG@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/11/24.2.png' ) ).

    "Eliminar entradas posibles; insertar nuevas entradas"
    DELETE FROM ZTB_CLIENTES_03.
    INSERT ZTB_CLIENTES_03 FROM TABLE @lt_clientes.
...
******** TABLA4
    ...
    "Eliminar entradas posibles; insertar nuevas entradas"
    DELETE FROM ZTB_CLNTS_LIB_03.
    INSERT ZTB_CLNTS_LIB_03 FROM TABLE @lt_clnts_lib.
...
******** TABLA5 ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' )
    ( id_libro = '000007' bi_categ = 'B' titulo = 'Tu hijo en crecimiento y tu religión' autor = 'Luka Brajnovic' editorial = 'KELVIN BOOKS' idioma = 'E' paginas = 380 precio = '65.49' moneda = 'USD' formato = 'P' url =
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' )
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' )
    ( id_libro = '000009' bi_categ = 'C' titulo = 'El lenguaje de la ciencia O' autor = 'MANIQUE, John' editorial = 'SALVAR EDICION' idioma = 'E' paginas = 125 precio = '14.99' moneda = 'USD' formato = 'P' url =
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' )
    ( id_libro = '000010' bi_categ = 'C' titulo = 'Energía en Evolución' autor = 'Meade, JE' editorial = 'ROW' idioma = 'E' paginas = 276 precio = '39.99' moneda = 'USD' formato = 'E' url =
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' )
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' )
    ( id_libro = '000012' bi_categ = 'D' titulo = 'Álgebra Matricial' autor = 'Jose manuel Gamboa' editorial = 'Anaya' idioma = 'S' paginas = 160 precio = '8.85' moneda = 'EUR' formato = 'P' url =
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' )
    ( id_libro = '000013' bi_categ = 'D' titulo = 'Matemáticas Galdós' autor = 'VV.AA' editorial = 'Cultural' idioma = 'S' paginas = 220 precio = 30 moneda = 'EUR' formato = 'P' url =
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' )
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' )
    ( id_libro = '000018' bi_categ = 'F' titulo = 'Ideal democracia y bienestar personal' autor = 'Llopis Goig, Ramón' editorial = 'Centro de Investig.' idioma = 'S' paginas = 268 precio = '9.5' moneda = 'EUR' formato = 'P' url =
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' )
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' )
    ( id_libro = '000022' bi_categ = 'G' titulo = 'Nada tan amargo: Seis poetas Inglesas' autor = 'VV.AA' editorial = 'DESVELO EDICIONES' idioma = 'S' paginas = 208 precio = '17.1' moneda = 'EUR' formato = 'E' url =
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' )
    ( id_libro = '000023' bi_categ = 'G' titulo = 'Poemas' autor = 'Maria Zambrano' editorial = 'SL EDICIONES' idioma = 'S' paginas = 212 precio = '15.1' moneda = 'USD' formato = 'P' url =
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' )
    ( id_libro = '000024' bi_categ = 'H' titulo = 'Atlas de los exploradores' autor = 'VV.AA' editorial = 'PLANETA' idioma = 'S' paginas = 320 precio = '34.15' moneda = 'USD' formato = 'E' url =
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' )
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Eliminar entradas posibles; insertar nuevas entradas"
    DELETE FROM ZTB_LIBROS_2803.
    INSERT ZTB_LIBROS_2803 FROM TABLE @lt_libros.

    IF sy-subrc = 0.
        out->write( |Libros: { sy-dbcnt } registros insertados| ).
    ENDIF.

    "Verifique el resultado en la consola
    out->write( '¡HECHO!' ).
